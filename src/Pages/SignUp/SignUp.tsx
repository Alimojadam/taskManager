      ...
      >
        ...
        <div className="w-full flex flex-col justify-center items-center gap-2">
          <div className="w-[50%] flex flex-col justify-center items-end gap-2">
            ...
            <input
              dir="rtl"
              className="w-full h-[30px] bg-transparent px-[5px] outline-none border border-[#B0B8C1] rounded-[5px] text-[#2C3E50]"
              type="text"
              value={name}
        ...
        <p onClick={handleLoginNavigate} className="text-[#4A90E2] cursor-pointer text-[15px] mt-2">
