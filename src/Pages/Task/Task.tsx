  ...
  return (
    <div className="w-full px-10 py-10 flex flex-col justify-center items-start gap-7">
      ...
      <div className="w-full flex justify-end items-start gap-4 mt-4">
        <div className="flex justify-center items-center gap-1 px-5 rounded-md cursor-pointer h-[35px] bg-[#E74C3C] text-[#FFFFFF] transition-all duration-300 ease-in-out hover:shadow-md hover:shadow-red-400">
            <p>حذف</p>
            <i className="bi bi-trash"></i>
        </div>
        <div className="flex justify-center items-center gap-1 px-5 rounded-md cursor-pointer h-[35px] bg-[#FFFFFF] text-[#2C3E50] border border-[#B0B8C1] transition-all duration-300 ease-in-out hover:shadow-md hover:shadow-[#6B7280]">
            <p>ویرایش</p>
